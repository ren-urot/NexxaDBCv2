...
function renderCard(data: CardData, interactive: boolean) {
  ...
  if (data.template === "professional") {
    return (
      <div className={`${wrapSize} relative overflow-hidden rounded-sm shadow-xl ${s.bg} flex flex-col justify-between`}>
        {overlays}
        <div
  ...
  if (data.template === "modern") {
    return (
      <div className={`${wrapSize} relative overflow-hidden rounded-sm shadow-xl ${s.bg} flex flex-col`}>
        {overlays}
        <div
  ...
  if (data.template === "executive") {
    return (
      <div className={`${wrapSize} relative overflow-hidden rounded-sm shadow-xl ${s.bg} flex flex-col justify-between px-7 py-6`}>
        {overlays}
  ...
  if (data.template === "creative") {
    return (
      <div className={`${wrapSize} relative overflow-hidden rounded-sm shadow-xl ${s.bg} flex`}>
        {overlays}
        <div
  ...
  if (data.template === "minimal") {
    return (
      <div className={`${wrapSize} relative overflow-hidden rounded-sm shadow-xl ${s.bg} flex flex-col justify-center px-8`}>
        {overlays}
  ...
  // Corporate (default)
  return (
    <div className={`${wrapSize} relative overflow-hidden rounded-sm shadow-xl ${s.bg} flex flex-col justify-between px-7 py-6 border ${s.border}`}>
      {overlays}
      <div className="flex justify-between items-start">
