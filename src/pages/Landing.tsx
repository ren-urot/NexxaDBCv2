    ...
    <div className="min-h-screen flex flex-col bg-[var(--color-background)] overflow-x-hidden">
      ...
      <section className="relative isolate pt-16 pb-16 bg-white overflow-hidden">
        ...
        <div className="w-full px-6 md:px-12">
          ...
          <div className="relative z-10 max-w-[1224px] mx-auto bg-white rounded-[20px] shadow-[0px_0px_20px_0px_rgba(0,0,0,0.06)] px-6 sm:px-8 py-8 flex flex-wrap lg:flex-nowrap items-center gap-x-6 gap-y-6 justify-between lg:-translate-y-[35px]">
        ...
        <div
          className="hidden lg:block absolute top-0 right-0 z-0 w-[calc(46%-40px)] 2xl:right-[300px] lg:[transform:translateY(50px)_scale(1.5)] xl:[transform:translateY(50px)_scale(1.5)] 2xl:[transform:translateY(50px)_scale(1.2)]"
