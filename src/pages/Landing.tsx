    ...
    <div className="min-h-screen flex flex-col bg-[var(--color-background)] overflow-x-hidden">
      ...
      <section className="relative isolate pt-16 pb-16 bg-white overflow-hidden">
        ...
        <div className="w-full px-6 md:px-12 2xl:translate-x-[130px]">
          ...
          <div className="hidden lg:flex relative z-10 max-w-[1224px] mx-auto bg-white rounded-[20px] shadow-[0px_0px_20px_0px_rgba(0,0,0,0.06)] px-6 sm:px-8 py-8 flex-wrap lg:flex-nowrap items-center gap-x-6 gap-y-6 justify-between lg:-translate-y-[35px] 2xl:-translate-y-[20px] 2xl:-translate-x-[130px]">
